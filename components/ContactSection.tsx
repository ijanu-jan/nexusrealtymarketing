        ...
        <Reveal variant="left">
          <div>
            ...
            <h2 className="mt-4 font-heading text-4xl font-extralight text-primary md:text-5xl">
              Speak with a <span className="text-gold">Nexus advisor</span>
            </h2>
            ...
            <ul className="mt-8 space-y-4 text-sm text-primary">
              ...
              <li className="flex items-start gap-3">
                <Phone />
                <a href="tel:+923314446666" className="hover:text-gold">0331 444 6666</a>
              </li>
              <li className="flex items-start gap-3">
                <Globe />
                <a href="https://nexusrealtymarketing.pk" className="hover:text-gold">
...
const iconClass = "mt-0.5 h-5 w-5 text-gold flex-shrink-0";

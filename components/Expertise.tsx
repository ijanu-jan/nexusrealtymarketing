            ...
            <div>
              ...
              <div className="mt-7">
                <a
                  ...
                  className="inline-flex items-center gap-3 rounded bg-gold px-7 py-3.5 text-sm font-medium uppercase tracking-wider text-white transition-all duration-300 hover:bg-gold-dark hover:translate-y-[-2px] hover:shadow-lg"
                >
                ...
                <Link href="/about" className="ml-3 text-sm font-medium uppercase tracking-wider text-primary hover:text-gold">
                  Meet the team →
                </Link>
              </div>
            </div>

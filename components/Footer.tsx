...
const socials = [
  ...
  { href: "https://wa.me/923001491799", label: "WhatsApp", icon: "M20.5 3.5A10.4 10.4 0 0 0 3.4 16.7L2 22l5.4-1.4a10.4 10.4 0 0 0 5 1.3 10.4 10.4 0 0 0 8.1-18.4zm-8.1 16.1a8.6 8.6 0 0 1-4.4-1.2l-.3-.2-3.2.8.9-3.1-.2-.3a8.6 8.6 0 1 1 7.2 4zm4.7-6.5c-.2-.1-1.5-.7-1.7-.8s-.4-.1-.6.1-.7.8-.8 1c-.1.1-.3.2-.5.1a7 7 0 0 1-3.5-3.1c-.3-.5.3-.4.7-1.4.1-.1 0-.3 0-.4l-.7-1.7c-.2-.4-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.4s-1 1-1 2.4 1 2.8 1.2 3 2 3 4.8 4.2c1.7.7 2.3.8 3.2.6.5-.1 1.5-.6 1.8-1.2.2-.6.2-1.1.1-1.2 0-.1-.2-.2-.5-.3z" },
    ...
    <footer className="bg-primary-deep text-white">
      <div className="container-x py-14 md:py-16">
        <div className="flex flex-col items-center text-center">
          <Image
            src="/assets/nexus-logo-complete.svg"

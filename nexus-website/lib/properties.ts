...
const localListings: Property[] = [
  {
    ...
    title: "1 Kanal Corner Designer House — DHA Phase 2, Islamabad",
    description:
    ...
    features: [
      ...
      "Elegant Drawing Room & Dining Area",
      "Open Lounge Concept",
  ...
  },
  {
    ...
    title: "1 Kanal Corner Designer House — DHA Phase 2, Islamabad (Unit II)",
    description:
      "Step into elegance with this stunning 1 Kanal Corner Designer House, perfectly located in the heart of DHA Phase 2. Crafted with exceptional attention to detail, this home blends luxury, comfort, and timeless architecture—ideal for families seeking an elite lifestyle in one of Islamabad's most prestigious communities.",
    location: "DHA Phase 2, Islamabad",
    city: "Islamabad",
  ...
  },
  {
    ...
    area_sqft: 6075,
    features: [
      "54 Marla Plot (27 Marla Covered + 27 Marla Landscaped Lawn)",
      "2 TV Lounges",
      "2 Modern Kitchens",
      "Elegant Drawing Room",
      "Formal Dining Room",
      "2 Independent Terraces",
